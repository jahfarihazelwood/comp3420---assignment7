...
function setUpPhong(program) {
    ...
    gl.uniform3fv(program.ambientLight, [0.2, 0.2, 0.2]);   // ambient light
    gl.uniform3fv(program.lightPosition, [5.0, 5.0, 5.0]);  // light source position
    gl.uniform3fv(program.lightColor, [1.0, 1.0, 1.0]);     // white light

    gl.uniform3fv(program.baseColor, [0.8, 0.2, 0.2]);      // reddish sphere
    gl.uniform3fv(program.specHighlightColor, [1.0, 1.0, 1.0]); // white highlight
    ...
    gl.uniform1f(program.ke, 20.0);  // shininess
